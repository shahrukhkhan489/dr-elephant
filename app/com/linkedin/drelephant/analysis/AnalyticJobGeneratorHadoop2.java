...
public class AnalyticJobGeneratorHadoop2 implements AnalyticJobGenerator {
  ...
  private static final String RM_HTTPS_ENABLED = "yarn.http.policy";
...
public class AnalyticJobGeneratorHadoop2 implements AnalyticJobGenerator {
  ...
  AnalyticJobGeneratorHadoop2() {
    ...
    if (RESOURCE_MANAGER_ADDRESS == null) {
      throw new RuntimeException(
              "Cannot get YARN HTTP Policy from Hadoop Configuration property: [" + RM_HTTP_POLICY
                      + "].");
    }
  }
 ...
 final String RM_NODE_STATE_URL = "http://%s/ws/v1/cluster/info";
